...
public class Seller {
    ...
    @Column(name="seller_date" , nullable = false )
    private String date;
	...
	public String toString() {
		return "Seller [id=" + id + ", fullname=" + fullname + ", email=" + email + ", gender=" + gender + ", password="
				+ password + ", contactno=" + contactno + ", date=" + date + ", location=" + location + "]";
	}
