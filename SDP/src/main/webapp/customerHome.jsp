...
<body>
    ...
    <header class="header">
        ...
        <div class="header-content">
            <h1>Welcome "<b style="color: #FF5733; font-size: larger;">${fname}</b>"</h1>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-4 col-md-2">
                    <div class="partner-logo">
                        <img src="images/homelog1.jpeg" alt="Partner 1" class="img-responsive">
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-2">
                    <div class="partner-logo">
                        <img src="images/homelog2.jpeg" alt="Partner 2" class="img-responsive">
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-2">
                    <div class="partner-logo">
                        <img src="images/homelog3.png" alt="Partner 1" class="img-responsive">
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-2">
                    <div class="partner-logo">
                        <img src="images/homelog4.jpeg" alt="Partner 2" class="img-responsive">
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-2">
                    <div class="partner-logo">
                        <img src="images/homelog5.webp" alt="Partner 1" class="img-responsive">
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-2">
                    <div class="partner-logo">
                        <img src="images/homelog6.png" alt="Partner 2" class="img-responsive">
    ...
    <div class="container-fluid py-5">
        <h2 style="text-align: center; color: #FF5733;"><b>OUR SERVICES</b></h2><br><br>
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4"
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            ...
                            <i class="fa fa-3x fa-headset text-white" style="margin-top: 30px;"></i>
                        </div>
                        <div style="margin-top: -85px;margin-left: 30px;">
                            <h4 class="text-uppercase m-0" style="color: #2B2E4A;font-size: 25px;"><b>24/7
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-secondary p-4 mb-4"
                        ...
                        <div style="margin-top: -85px; color: #ddd;margin-left: 35px;">
                            <h4 class="text-light text-uppercase m-0" style="color: #ffffff;font-size: 25px;"><b>All
                                    types of Spare <br>Parts Available</b></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4"
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 100px; height: 100px; background-color: #FF5733;margin-top: 25px;">
                            <i class="fa fa-3x fa-map-marker-alt text-white" style="margin-top: 30px;"></i>
                        </div>
                        <div style="margin-top: -85px;margin-left: 30px;">
                            <h4 class="text-uppercase m-0" style="color: #2B2E4A;font-size: 25px;"><b>Lots Of
    ...
    <div class="container contact-section">
        <h2 style="text-align: center; color: #FF5733;"><b>CONTACT</b><b style="color: #000000;"> US</b></h2><br><br>
        <div class="row">
            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="${fname}" id="name" placeholder="Enter your name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">Your Email</label>
                                    <input type="email" class="form-control" id="email" value="${email}" placeholder="Enter your email" readonly >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="contact-info">
                    ...
                    <p><i class="fas fa-map-marker-alt" style="color: #FF5733;"></i> Vaddeswaram, Vijayawada, AP</p>
                    <p><i class="fas fa-envelope" style="color: #FF5733;"></i> XperienceAuto@gmail.com</p>
                    <p><i class="fas fa-phone" style="color: #FF5733;"></i> 8639555561, 7207294455</p>
                </div>
            </div>
        </div>
    </div>
