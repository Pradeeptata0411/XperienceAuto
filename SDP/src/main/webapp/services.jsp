...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="glyphicon glyphicon-log-in"></i>&nbsp&nbspLOGIN&nbsp&nbsp
                        </a>
                        <ul class="dropdown-menu">
                   			  <li style="font-size: 18px"><a href="customerLogin">Customer Login</a></li>
                             <li style="font-size: 18px"><a href="sellerpage">Seller Login</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Our Services</h1><br>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item active d-flex flex-column justify-content-center px-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="d-flex align-items-center justify-content-center bg-custom-color ml-n4">
                                <!-- Update the color of the icon -->
                                <i class="fa fa-money-check text-secondary" style="color: white;"></i>
                            </div>
                            <div class="service-number">01</div>
                        </div>
                        <h4 class="text-uppercase mb-3">Car Spare Parts</h4>

                        <p class="m-0">High-quality car spare parts for all makes and models, ensuring reliable performance and safety on the road</p>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item active d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <p class="m-0">Car financing provides the opportunity to purchase a vehicle through affordable installment plans.</p>
                        <a href="customerLogin" class="btn btn-primary mt-3">Know More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <p class="m-0">Car inspection is a thorough examination of a vehicle's condition, ensuring safety, functionality.</p>
                        <a href="customerLogin" class="btn btn-primary mt-3">Know More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <p class="m-0">Auto repairing: expert services to keep your car running smoothly, from diagnostics to maintenance and repairs</p>
                        <a href="customerLogin" class="btn btn-primary mt-3">Know More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <p class="m-0">Auto painting: Revitalize your car's appearance with professional paintwork, color matching,finishing services.</p>
                        <a href="customerLogin" class="btn btn-primary mt-3">Know More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <p class="m-0">Auto cleaning: Restore your car's shine and freshness with thorough interior and exterior cleaning.</p>
                        <a href="customerLogin" class="btn btn-primary mt-3">Know More</a>
                    </div>
                </div>
            </div>
