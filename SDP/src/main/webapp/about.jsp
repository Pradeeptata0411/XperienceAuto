...
<body>
    ...
    <div class="header-container">
        <h1 style="color: rgb(0, 0, 0); font-size: 90px;"><b>About Us</b></h1>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <img src="/images/surya.jpg" alt="Card 1 Image" class="card-img-top">
                    <div class="card-body">
                        <h3>Mentor</h3>
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="/images/pradeep.jpg" alt="Card 2 Image" class="card-img-top">
                    <div class="card-body">
                        <h3>Team Leader</h3>
                        <p>Name : T. Pradeep</p>
                        <p>ID : 2100030875</p>
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="/images/akshay.jpg" alt="Card 3 Image" class="card-img-top">
                    <div class="card-body">
                        <h3>Team Member</h3>
                        <p>Name : K. Akshay</p>
                        <p>ID : 2100030871</p>
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="/images/harsha.jpg" alt="Card 4 Image" class="card-img-top">
                    <div class="card-body">
                        <h3>Team Member</h3>
