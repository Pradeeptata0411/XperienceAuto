...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container1-fluid">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/sellerpage/index">XperienceAuto</a></li>
            </ul>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/sellerpage/index"><i class="fas fa-home"></i> HOME</a></li>
                    <li class="user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="glyphicon glyphicon-log-in"></i>LOGIN&nbsp&nbsp
                        </a>
    ...
    <form style="margin-top: 150px;" method="post" action="sellerRegistration">
    <span class="blink">
	<h5 align="center" style="color:red">${message}</h5>
        ...
        <input type="email" name="email" id="email" pattern=".+@gmail\.com" placeholder="Enter email" title="email format must be xxx@gmail.com" required>
         ...
         <label for="location"><i class="fas fa-envelope"></i> Location </label>
        <input type="text" name="location" id="location"  placeholder="Enter Location " required>
         
         <label for="date"><i class="fas fa-envelope"></i> Location </label>
        ...
        <input type="text" name="contact" id="phone" pattern="[789][0-9]{9}"  placeholder="Must be 10 digits" required>


        <button type="submit" class="button-blue">Register</button><br><br>
        <span class="username">Already have an account? <a href="customerLogin"><u>Login in here</u> </a></span>
    </form>
